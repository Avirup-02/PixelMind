    ...
    return (
      ...
      <footer className="bg-white-900 text-black py-10">
        <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
          ...
          {/* About Section */}
          <div>
            <h3 className="text-xl font-semibold mb-3">About PixelMind</h3>
            <p className="text-gray-400 text-sm">
              AI-powered image generation and emotion-based recommendations to enhance well-being.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">Email: support@pixelmind.com</p>
        ...
        <div className="border-t border-gray-700 text-center text-sm text-gray-500 mt-6 pt-4">
          © 2024 PixelMind. All rights reserved.
        </div>
      </footer>
      </div>
    );
